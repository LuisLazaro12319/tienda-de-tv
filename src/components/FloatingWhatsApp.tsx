...
export const FloatingWhatsApp: React.FC = () => {
  const { whatsappPhone, toastMessage } = useStore();
  ...
  return (
    <>
      ...
      <aside aria-label="Contacto rápido por WhatsApp" className="fixed bottom-5 right-5 z-40">
        <a
          href={buildSupportWhatsAppUrl(whatsappPhone)}
          target="_blank"
          rel="noopener noreferrer"
          className="group flex items-center justify-center w-14 h-14 bg-[#25D366] hover:bg-[#20ba59] text-white rounded-full shadow-2xl shadow-[#25D366]/40 transition-all duration-200 hover:scale-110 active:scale-95"
